    ...
    <header class="header bg">
        <div class="container text-white">
            <div class="row align-items-center">
                <div class="col-sm-4 text-left px-1">
                    <a class=" navbar-brand href=index.html">
                        ...
                        <img src="<?= base_url('assets/upload/logo/logo-navbar.png'); ?>" alt="logo"
                            class="logo logoside">
                    </a>
                </div>
    ...
    <div id="blog-single">
        <section class="section4 more-blog" data-aos="fade-up" data-aos-duration="700">
            <div class="text-center pb-2">
                <h2 class="background"><span style="font-size:35px;">
                        <?= $nama_kategori; ?> </span>
                </h2>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="d-flex justify-content-center mb-3">
                                    <small class="mr-3"><i class="fa-solid fa-user" style="color: #000000;"></i>
                                        <?= $aa['nama'] ?></small>
                                    <small class="mr-3">
                                        <i class="fa fa-folder" style="color: #000000;"></i>
                                        <?= $aa['nama_kategori'] ?>
                                    </small>
